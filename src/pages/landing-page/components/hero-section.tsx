  ...
  return (
    <section className="w-app-w mx-auto text-white pt-10 md:flow-root min-h-[40vh]">
      <div className="flex flex-col">
        <h4 className="uppercase text-sm md:text-3xl font-playfair">made in Indonesia, dedicated to Indonesia</h4>
        <h1 className="font-extrabold text-3xl md-lg:text-3xl font-playfair md:text-8xl uppercase w-[85vw] leading-tight">Discover the Art of Dressing Up</h1>
      </div>
      <div className=" flex flex-col gap-6 md:float-right ">
        {
          heroCardItem.map(({ img,
            productName,
            price,
            text,
            href,
            ...
            <div key={productName} className={`flex bg-white  rounded-sm${reverse ? "flex-row-reverse" : ""}`}>
